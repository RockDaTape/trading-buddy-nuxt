...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "93c26796-13f6-4e6b-9ec4-187b5ab6ee0b",
...
const _0ZN_4cozsYCqKkmOIfKCeoZXTkQxtSxidcrBrWKbT90 = (function(nitro) {
...
const plugins = [
  _0ZN_4cozsYCqKkmOIfKCeoZXTkQxtSxidcrBrWKbT90
];
...
const _rmyLOU = defineCachedEventHandler(async (event) => {
...
const _lazy_jbC5kA = () => import('../build/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_jbC5kA, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _rmyLOU, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_jbC5kA, lazy: true, middleware: false, method: undefined }
];
...
export { getResponseStatus as a, buildAssetsURL as b, getQuery as c, defineRenderHandler as d, createError$1 as e, getRouteRules as f, getResponseStatusText as g, useNitroApp as h, handler as i, publicAssetsURL as p, useRuntimeConfig as u };
